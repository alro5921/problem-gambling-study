...
EVENT_CODE_DICT = {1: "Family Intervention", 2 : "Account Close/Open From RG", 3 : "Cancelled Outpayment", 
                   ...
                   11: "High Deposit", 12 : "Two RG Events On Day", 13: "Event Unknown"}
...
def make_ts(gam_data, user_id, product_type, demographic_df = None):
    ...
    reg_date = demographic_df.loc[user_id].registration_date if demographic_df is not None else '2000-01-01'
